...
public class KafkaSparkStreamETL {
        ...
        public static void main(String[] args) {
                ...
                Dataset<Row> designationDS=empDS.select("id","designation");
                 StreamingQuery streamingQuery = null;
                try {
                        streamingQuery =designationDS.writeStream().trigger(Trigger.ProcessingTime(30, TimeUnit.SECONDS))
                                        .format("csv").option("header", true).option("checkpointLocation",
                                                        "c:/checkpointforetl").start("c:/structuredstreamkafkacsvout-1");
